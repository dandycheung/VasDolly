...
internal data class SimpleAGPVersion(
    ...
    companion object {
        val ANDROID_GRADLE_PLUGIN_VERSION by lazy {
            ...
            error("Unable to obtain AGP version. It is likely that the AGP version being used is too old.")
        }

        fun parse(version: String?) = tryParse(version) ?: error("Unable to parse AGP version: $version")
